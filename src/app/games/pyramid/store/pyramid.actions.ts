...
export class AddPyramid implements Action {
  ...
  constructor(public payload: {num1:number, num2:number, num3:number, num4:number, num5:number, num6:number, num7:number, num8:number}){}
}

export type PyramidActionsTypes =
  | NewPyramid
  | AddPyramid
